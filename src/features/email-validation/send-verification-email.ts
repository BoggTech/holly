...
const STARTER_EMAIL_SUBJECT =
  "Science Fiction & Fantasy Society Discord";
...
For safety, all members of the server must confirm their TCD email. 
When you join:
...
If Discord's not your style, you may find our linktree useful:
